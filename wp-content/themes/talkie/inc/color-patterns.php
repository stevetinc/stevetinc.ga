 ...
 */
function talkie_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter talkie default saturation level.
	 *
	 * @since talkie 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'talkie_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.talkie-front-page) .entry-title,
...
.colors-custom .talkie-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.talkie-front-page .panel-content .recent-posts article,
...
.colors-custom.talkie-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters talkie custom colors CSS.
	 *
	 * @since talkie 1.0
	 *
	 ...
	 */
	return apply_filters( 'talkie_custom_colors_css', $css, $hue, $saturation );
}
?>